...
def status():
    ...
    token = "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"  # Replace with your GitHub token
    ...
    json_file_path = os.path.join(CLONE_DIR, "data.json")  # Path to the JSON file in the repo
    ...
    if json_data is None:
        return jsonify({"error": "Failed to read JSON file from cloned repository"}), 500
